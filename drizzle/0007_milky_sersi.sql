ALTER TABLE "orders" ADD COLUMN "user_id" serial NOT NULL;--> statement-breakpoint
ALTER TABLE "orders" ADD COLUMN "product_id" serial NOT NULL;--> statement-breakpoint
ALTER TABLE "orders" ADD COLUMN "status" varchar(10) DEFAULT 'pending' NOT NULL;--> statement-breakpoint
ALTER TABLE "orders" ADD COLUMN "type" varchar(6) DEFAULT 'quick' NOT NULL;--> statement-breakpoint
